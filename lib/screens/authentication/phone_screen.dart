...
class _PhoneScreenState extends State<PhoneScreen> {
  ...
  Future<void> _trySubmit() async {
    ...
    var c = countries.where((country) => country.dialCode == _country);
    print(c.first.maxLength);
    if (c.first.maxLength == phoneNumber.length && phoneNumber.isNotEmpty) {
      if (isValid) {
        _formKey.currentState!.save();
        await Provider.of<Auth>(context, listen: false)
            .submitPhoneNumber('+${_country}', phoneNumber);
