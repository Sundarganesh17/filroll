...
class AuthCard1 extends StatefulWidget {
  final void Function(
      String name, String userName, String email, String password) submitFn;

  AuthCard1(this.submitFn);

  @override
  State<AuthCard1> createState() => _AuthCard1State();
}

class _AuthCard1State extends State<AuthCard1> {
  ...
  Future<void> _trySubmit() async {
    ...
    if (isValid) {
      ...
      await Provider.of<Auth>(context, listen: false).signUp(name!, userName!,
                ...
                child: Row(
                  ...
                  children: [
                    TextButton(
                      ...
                      // https://filroll.com/terms-and-conditions
                      // https://filroll.com/privacy-policy
