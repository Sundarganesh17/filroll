...
import 'package:filroll_app/screens/feed/suggest_profiles.dart';
...
class FeedList extends StatefulWidget {
  final snap;
  final index;
  const FeedList({super.key, required this.snap, this.index});
...
class _FeedListState extends State<FeedList> {
  ...
  void getDp() async {
    ...
    setState(() {
      ...
      blockedList = (snap.data() as Map<String, dynamic>)['blockedUsers'];
    ...
    return isLoading
        ...
        : postOwnerDpUrl.isEmpty
            ...
            : WillPopScope(
                ...
                child: Column(
                  children: [
                    if (!blockedList.contains(widget.snap.uid))
                      Container(
                          color: Colors.black,
                          width: size.width,
                          child: Column(
                    ...
                    // if (widget.index == 2) SuggestProfiles(),
                  ],
                ),
              );
  }
